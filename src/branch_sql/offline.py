...
from ..offline.chunk import table_chunker as chunking
from ..offline.parse import docx_parse as parse
...
def build_chain(
    *,
    ...
    def _knowledge(result: dict) -> dict:
        ...
        from ..offline.link import knowledge_graph as knowledge
    ...
    def _index(result: dict) -> dict:
        ...
        from ..offline.index import qdrant_store as store

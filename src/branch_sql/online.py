...
from ..online.rerank import ScoringReranker, get_reranker
from ..online.qdrant_retriever import QdrantRetriever
...
def main(argv: list[str]) -> int:
    ...
    if not docs:
        print("không có kết quả - collection rỗng? chạy src.offline trước")
        return 1
